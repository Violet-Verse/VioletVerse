...
const Stardust = () => {
  ...
  const siteDescription = 'Check your tokens and level up in the Stardust game.'
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ maxWidth: '700px', margin: '0 auto' }}>
            We are thrilled to present an immersive and rewarding content economy that
            strengthens the connection between readers and writers, while unlocking new
            avenues for revenue generation. By harnessing the cutting-edge blockchain
            tools provided by Stardust, Violet Verse members can gain access to exclusive
            content, show appreciation to creators through tips, utilize minting services,
            and redeem rewards, among other exciting possibilities. Within the Verse
            Publishing platform, VV Credits serve as the native credit system.
          </Typography>
        </Container>
        ...
        >
          ...
          <Typography variant="body1" sx={{ maxWidth: '700px', margin: '0 auto' }}>
            It&apos;s as simple as logging in to the Verse with an email and joining our
            vibrant community of fashion media brands, publishers, and creators. As
            members accumulate tokens, our community leaderboard will showcase the top
            profiles, verifying the most dedicated superfans, supporters, and collectors.
          </Typography>
        </Container>
        <Grid item>
          <CardContainer
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <Typography variant="h5" component="p" textAlign={'center'} mb={2}>
              Leaderboard
            </Typography>
                ...
                <TableBody>
                  {leaderboardData.map((row) => (
                    <LeaderBoardRow key={row.name}>
                      <LeaderBoardCell component="th" scope="row">
                        {row.rank}
                      </LeaderBoardCell>
                      <LeaderBoardCell>{row.name}</LeaderBoardCell>
                      <LeaderBoardCell>{row.score}</LeaderBoardCell>
                    </LeaderBoardRow>
                  ))}
                </TableBody>
              </Table>
        ...
        <Grid item>
          <Image src={stardustInfo.image} alt="Stardust Logo" width={200} height={200} />
        </Grid>
      </Grid>
    </Box>
  )
