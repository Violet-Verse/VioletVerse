...
function PostsTable(props) {
  ...
  function createData(title, author, category, draftStatus, slug, created, _id) {
  ...
  function ApprovalDialog({ open, onClose, onConfirm, article, isApproving }) {
    return (
      <Dialog
        open={open}
        onClose={onClose}
            ...
            <TableRow>
              ...
              <TableCell>
                <TableSortLabel
                  ...
                  direction={orderBy === dateSortType ? order : 'asc'}
                  onClick={(event) => handleSort(event, dateSortType)}
                >
                  Created Date
                </TableSortLabel>
              </TableCell>
              ...
              <TableCell>
                <TableSortLabel
                  ...
                  direction={orderBy === 'draftStatus' ? order : 'asc'}
                  onClick={(event) => handleSort(event, 'draftStatus')}
                >
                  Draft Status
                </TableSortLabel>
              </TableCell>
