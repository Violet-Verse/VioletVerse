  ...
  const newToWeb3Block = [
    {
      ...
      description: 'Your go-to guide to getting started in the web3 space.',
      url: '/the-violet-verse-web3-glossary-TLraj5m2VD',
    },
    {
      name: 'Resources',
      description: 'Discover resources on all things crypto, blockchain, NFT, and more.',
      url: '/resources',
    },
    {
      name: 'Events/Meetups',
        ...
        {newToWeb3Block.map((section) => (
          <Grid item sm={12} md={4} key={section.name}>
            ...
            >
              ...
              >
                <Grid item>
                  <h3 className={styles.header}>{section.name}</h3>
                </Grid>
                <Grid item>
                  <h5 className={styles.body}>{section.description}</h5>
                </Grid>
                <Grid item>
                  <Link href={section.url} legacyBehavior>
                    <a>
                      <h5 className={styles.link}>Learn more</h5>
                    </a>
                  </Link>
                </Grid>
              </Grid>
