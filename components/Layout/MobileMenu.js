...
const MenuItemComp = memo(({ index, children }) => (
    <motion.div
            ...
            <AnimatePresence mode="wait">
                {isMobileMenuOpen && (
                    ...
                    >
                        ...
                        <MenuItemComp index={!user && loaded ? 1 : 0}>
                            <button
                                type="button"
                                    ...
                                    {categories.map((category, subIndex) => (
                                        <SubmenuItem key={category.href} index={subIndex}>
                                            <button
                                                ...
                                                onClick={() => {
                                                    handleSubmenuClick(category.name);
                        ...
                        <MenuItemComp index={!user && loaded ? 2 : 1}>
                            <button
                                type="button"
                                className={mobileMenuClasses.menuButton}
                                onClick={() => {
                        ...
                        <MenuItemComp index={!user && loaded ? 3 : 2}>
                            <a
                                target="_blank"
                                href="/vr"
                        ...
                        <MenuItemComp index={!user && loaded ? 4 : 3}>
                            <button
                                type="button"
                                className={mobileMenuClasses.menuButton}
                                onClick={() => {
                        ...
                        <MenuItemComp index={!user && loaded ? 5 : 4}>
                            <button
                                type="button"
                                className={mobileMenuClasses.menuButton}
                                onClick={() => {
