...
const NewNav = () => {
  ...
  const login = async () => {
    try {
      ...
      const userEmail = res.services.find((services) => services.type === 'open-id').data
        .email.email
        ...
        fetch('/api/auth/verify', {
          ...
          .then((result) => {
            global.analytics.track(
              result.registration ? 'User Registration Success' : 'User Login Success ',
              {
                ...(result.registration && {
              ...
              {user && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image alt="edit" src="/star.svg" height={16} width={16} />
                      &nbsp;&nbsp;
                      {vvTokens ? `${vvTokens} $VV Tokens` : `Setup VV Wallet`}
                    </Button>
                  </Box>
              ...
              {!user && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <PersonOutlineSharpIcon sx={{ fontSize: '32px' }} />
                    </IconButton>
                  </Box>
